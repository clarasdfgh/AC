...
int main(int argc, char** argv){ 
  ...
  printf("\nTamanio Vectores:%u (%lu B)\n",N, sizeof(unsigned int));
	...
	v3 = (double*) malloc(N*sizeof(double));
  	if ((v1 == NULL) || (v2 == NULL) || (v2 == NULL)) {	
    	printf("\nNo hay suficiente espacio para los vectores \n");
    	exit(-2);
  	}
  #endif
  ...
  if (N<10) {
    ...
    printf("\nTiempo:%11.9f\t / Tamanio Vectores:%u\t/ V1[0]+V2[0]=V3[0](%8.6f+%8.6f=%8.6f) / / V1[%d]+V2[%d]=V3[%d](%8.6f+%8.6f=%8.6f) /\n",
